...
class UeMetrics(google.protobuf.message.Message):
    ...
    NOF_PRACH_SENT_FIELD_NUMBER: builtins.int
    rnti: builtins.int
    """UE identification"""
    pci: builtins.int
    ...
    nof_prach_sent: builtins.int
    """PRACH preambles transmitted by the UE"""
    def __init__(
        self,
        *,
        rnti: builtins.int = ...,

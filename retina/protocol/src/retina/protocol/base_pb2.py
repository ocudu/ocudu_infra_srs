...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CUCPMETRICS']._serialized_end=3800
  _globals['_METRICS']._serialized_start=3803
  _globals['_METRICS']._serialized_end=3954
